  ...
  return (
    <section className="p-3">
      ...
      <section className="mb-6">
        ...
        <p>
          Bilingual Fullstack Developer with more than 3 years of solid experience in modern frontend and backend, including Angular, NestJS, React, and Python. I deliver scalable solutions focusing on performance, AI, and cloud computing.
        </p>
      </section>
